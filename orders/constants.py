...
class FileConstants:
    ...
    # Обновлено до 2GB для соответствия настройкам Django
    ...
    MAX_EXCEL_SIZE_MB = 2048  # 2GB
    MAX_PDF_SIZE_MB = 2048  # 2GB
...
class TimeConstants:
    ...
    # Время для напоминаний фабрикам о загрузке инвойса (в днях)
    INVOICE_REMINDER_DAYS = 5  # Напоминание фабрике через 5 дней после отправки заказа
    FACTORY_REMINDER_FREQUENCY = 3  # Частота повторных напоминаний фабрике (в днях)
