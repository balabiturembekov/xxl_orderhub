...
from orders.views.public_views import PublicInvoiceList
from .views import (
    # Order views
    OrderListView,
    OrderDetailView,
    ...
    CancelledByClientOrderListView,
    update_factura_type,
    # E-Factura views
    EFacturaBasketListView,
    EFacturaBasketDetailView,
    upload_efactura_file,
    download_efactura_file,
    download_all_efactura_files,
    # Confirmation views
...
from .views.email_template_views import (
    ...
    email_template_duplicate,
    email_template_activate,
    email_template_set_default,
    email_template_export,
    email_template_import,
    email_template_variables_help,
...
urlpatterns = [
    ...
    path(
        "orders/<int:pk>/cancel-by-client/",
        cancel_order_by_client,
        name="cancel_order_by_client",
    ),
    path(
        "orders/<int:pk>/update-factura-type/",
        update_factura_type,
        name="update_factura_type",
    ),
    path(
        "orders/cancelled-by-client/",
        CancelledByClientOrderListView.as_view(),
        name="cancelled_by_client_list",
    ),
    path("orders/<int:pk>/send/", send_order, name="send_order"),
    path("orders/<int:pk>/upload-invoice/", upload_invoice, name="upload_invoice"),
    path(
        "orders/<int:pk>/upload-invoice-form/",
        upload_invoice_form,
        name="upload_invoice_form",
    ),
    path(
        "orders/<int:pk>/upload-invoice-execute/",
        upload_invoice_execute,
        name="upload_invoice_execute",
    ),
    path("orders/<int:pk>/complete/", complete_order, name="complete_order"),
    path(
        "orders/<int:pk>/download/<str:file_type>/", download_file, name="download_file"
    ),
    # AJAX endpoints
    ...
    path(
        "confirmations/<int:pk>/approve/",
        confirmation_approve,
        name="confirmation_approve",
    ),
    path(
        "confirmations/<int:pk>/reject/",
        confirmation_reject,
    ...
    path(
        "orders/<int:pk>/preview-modal/<str:file_type>/",
        preview_file_modal,
        name="preview_file_modal",
    ),
    # Управление инвойсами и платежами
    path("invoices/", InvoiceListView.as_view(), name="invoice_list"),
    path("invoices/<int:pk>/", InvoiceDetailView.as_view(), name="invoice_detail"),
    path(
        "invoices/<int:pk>/edit-balance/",
        invoice_balance_edit,
        name="invoice_balance_edit",
    ),
    path(
    ...
    path(
        "orders/<int:order_id>/upload-invoice-with-payment/",
        upload_invoice_with_payment,
        name="upload_invoice_with_payment",
    ),
    path("payment-analytics/", payment_analytics, name="payment_analytics"),
    # Управление CBM
    path(
        "orders/<int:order_id>/cbm/create/", CBMCreateView.as_view(), name="cbm_create"
    ),
    ...
    path(
        "shipments/<int:pk>/edit/", ShipmentUpdateView.as_view(), name="shipment_update"
    ),
    path(
    ...
    path(
        "email-templates/", EmailTemplateListView.as_view(), name="email_template_list"
    ),
    path(
    ...
    path(
        "email-templates/<int:pk>/duplicate/",
        email_template_duplicate,
        name="email_template_duplicate",
    ),
    path(
        "email-templates/<int:pk>/activate/",
        email_template_activate,
        name="email_template_activate",
    ),
    path(
        "email-templates/<int:pk>/set-default/",
        email_template_set_default,
        name="email_template_set_default",
    ),
    path(
        "email-templates/<int:pk>/export/",
        email_template_export,
        name="email_template_export",
    ),
    path(
        "email-templates/import/", email_template_import, name="email_template_import"
    ),
    path(
        "email-templates/variables-help/",
        email_template_variables_help,
        name="email_template_variables_help",
    ),
    path(
        "email-templates/preview-ajax/",
        email_template_preview_ajax,
        name="email_template_preview_ajax",
    ),
    # Управление корзинами E-Factura
    path(
        "efactura/baskets/",
        EFacturaBasketListView.as_view(),
        name="efactura_basket_list",
    ),
    path(
        "efactura/baskets/<int:pk>/",
        EFacturaBasketDetailView.as_view(),
        name="efactura_basket_detail",
    ),
    path(
        "efactura/baskets/<int:basket_id>/upload/",
        upload_efactura_file,
        name="upload_efactura_file",
    ),
    path(
        "efactura/files/<int:file_id>/download/",
        download_efactura_file,
        name="download_efactura_file",
    ),
    path(
        "efactura/baskets/<int:basket_id>/download-all/",
        download_all_efactura_files,
        name="download_all_efactura_files",
    ),
    # Public views
    path(
        "api/public/invoices/<int:pk>/",
        PublicInvoiceList.as_view(),
        name="public_invoice_list",
    ),
]
